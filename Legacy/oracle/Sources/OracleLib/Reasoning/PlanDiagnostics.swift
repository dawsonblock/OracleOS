...
// MARK: - ScoredPlanSummary

/// A lightweight summary of a scored plan candidate for diagnostics.
...
// MARK: - PlanDiagnostics

/// Diagnostic information about the plan selection process for a single planning cycle.
