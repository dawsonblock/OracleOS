...
// MARK: - PatternSimilarityCalculator

public enum PatternSimilarityCalculator {

    /// Jaccard + order similarity between two action sequences.
    public static func similarity(between lhs: [String], and rhs: [String]) -> PatternSimilarity {
        ...
        return PatternSimilarity(score: combined, matchedSignals: signals, source: .actionSequence)
    }

    /// Token-level Jaccard similarity between two goal descriptions.
    public static func taskFamilySimilarity(goalA: String, goalB: String) -> PatternSimilarity {
