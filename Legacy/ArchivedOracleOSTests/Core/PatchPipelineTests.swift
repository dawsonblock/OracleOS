...
struct PatchPipelineTests {
    ...
    func rejectsUnbalancedBraces() {
        ...
        let snapshot = RepositorySnapshot(
            id: "x", workspaceRoot: "/x", buildTool: .swiftPackage, files: [], symbolGraph: SymbolGraph(), dependencyGraph: DependencyGraph(), testGraph: TestGraph(), activeBranch: "main", isGitDirty: false,
