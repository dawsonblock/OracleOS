...
struct StrategyScopedMemoryTests {
    ...
    func biasRequiresStrategy() {
        let calculator = MemoryDecisionBiasCalculator(memoryStore: AppMemoryStore())
        ...
        #expect(bias.totalBias >= -1.0 && bias.totalBias <= 2.0)
    }
    ...
    private func makeReasoningState() -> ReasoningPlanningState {
        ...
        let worldState = makeWorldState(app: "Test")
