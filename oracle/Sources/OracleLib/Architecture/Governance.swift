...
public enum GovernanceRuleID: String, Codable, Sendable, CaseIterable {
    ...
    public var title: String {
        switch self {
        case .executionTruthPath:   return "Execution Truth Path"
        case .reusableKnowledge:    return "Reusable Knowledge vs Episode Residue"
        case .hierarchicalPlanning: return "Hierarchical Planning / Local Execution"
        case .recoveryMode:         return "Recovery as First-Class Execution Mode"
        case .evalBeforeGrowth:     return "Evaluation Before Architecture Growth"
        }
    }
}

// MARK: - GovernanceSeverity
...
// MARK: - GovernanceViolation → ArchitectureFinding bridge
...
extension GovernanceViolation {
    public func asArchitectureFinding() -> ArchitectureFinding {
        ArchitectureFinding(
            ...
            evidence: evidence,
            riskScore: severity == .hardFail ? 0.95 : 0.70,
