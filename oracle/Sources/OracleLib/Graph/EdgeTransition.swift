...
public final class EdgeTransition: @unchecked Sendable {
    ...
    public var reasoningEdge: GraphEdge {
        GraphEdge(
            id: edgeID,
            fromStateID: fromPlanningStateID,
            toStateID: toPlanningStateID,
            actionContractID: actionContractID,
            stable: knowledgeTier == .stable,
            weight: max(successRate, confidence)
        )
    }
